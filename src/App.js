    ...
    if (page === 'bio') {
      ...
      return (
        <div className="App-contents">
          ...
          <Project key="otl" name="Open Textbook Library" url="https://open.umn.edu/opentextbooks" subtitle="University of Minnesota, 2018-" description="The Open Textbook Library provides a growing catalog of free, peer-reviewed, and openly-licensed textbooks.<br/> Built with Ruby on Rails and Bootstrap." img={otl} />
